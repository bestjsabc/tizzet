@selected_plugin_titles = %w{ Pages Images Refinery Settings Dialogs Resources Users}
@user = User.new({
  :login => ADMIN_USER,
...
# Seed file which sets up... well, everything in a default install.
[{:name => "site_name", :value => SITE_NAME},
  ...
  {:name => "analytics_page_code", :value => GOOGLE_ANALYTICS_PAGE_CODE},
  {:name => "theme", :value => "webfirm"},
